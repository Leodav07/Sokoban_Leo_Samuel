...
import com.sokoban.juego.logica.Mapas.MapaSeis;
import com.sokoban.juego.logica.Mapas.MapaSiete;
...
public class NivelSieteScreen implements Screen, MapaBase.MapaBaseListener {

    private SpriteBatch batch;
    private Main game;
    private MapaSiete mapa;
    ...
    public NivelSieteScreen(Main game) {
        this.game = game;
    ...
    private void inicializarNivel() {
        ...
        mapa = new MapaSiete(16, 22, muro, caja, objetivo, suelo, jugador, cajaObjetivo, fondo, game);
