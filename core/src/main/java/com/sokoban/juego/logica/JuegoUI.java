...
public class JuegoUI {
  private BitmapFont font;
    ...
    public void dibujar(SpriteBatch batch, int mapWidth, int mapHeight, long tiempoPausado) {
        ...
        shapeRenderer.rect(0, panelY, screenWidth, PANEL_HEIGHT);
        shapeRenderer.end();
        ...
        dibujarInformacionJuego(batch, panelY, tiempoPausado);
    }
    
    private void dibujarInformacionJuego(SpriteBatch batch, int panelY, long tiempoPausado) {
        int x = MARGIN;
        ...
        font.draw(batch, "ESC o P: Pausa | R: Reiniciar | TAB: Estadísticas", x, y - 20);
